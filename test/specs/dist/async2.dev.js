...
describe('eCommerce Application', function () //this is a test suite, takes 2 arguments
//'=>' instead of the keyword function as it is an anonymous function
{
  xit('login page title', function () //this is a single test case inside the test suite, takes 2 arguments
  {
    browser.url("https://rahulshettyacademy.com/loginpagePractise/#"); //validate correct website has opened

    console.log(browser.getTitle()); //assertions to verify results

    expect(browser).toHaveTitleContaining("Rahul Shetty Academy"); //entering a value in edit box by name
    ...
    $("#signInBtn").click(); //$("#signInBtn").getAttribute('value') === 'Sign in'
